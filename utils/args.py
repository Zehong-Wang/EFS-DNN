...
def get_args():
    ...
    parser.add_argument('--bs', type=int, default=256, help='The batch size')
    parser.add_argument('--num_in_feat', type=int, default=20, help='The number of input features')
    parser.add_argument('--n_lgb', type=int, default=10, help='The number of LightGBM')
